...
<body>
            ...
            <div class="container mx-auto px-6 ">
                <div class="flex items-center justify-between">
                    <div class="hidden w-full text-gray-600 md:flex md:items-center">
                        ...
                        <span class="mx-1 text-sm">Neiva-Huila</span>
                    </div>
                    ...
                    <div class=" absolute right-24 top-2">
                        @guest
                            <a class="p-2 bg-blue-600 rounded text-white hover:text-blue-600 hover:bg-white border border-blue-500"
                                href="{{ route('login') }}">Login</a>
                        @else
                            <a class="p-2 bg-blue-600 rounded text-white hover:text-blue-600 hover:bg-white border border-blue-500"
                                href="{{ route('dasboard.inicio') }}">dashboard</a>
                ...
                <nav :class="isOpen ? '' : 'hidden'" class="sm:flex sm:justify-center sm:items-center mt-4">
                    <div class="flex flex-col sm:flex-row">
                        ...
                        <a class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" href="#">Contactenos</a>
                    </div>
                </nav>
    ...
    <footer class="bg-gray-200">
        <div class="container mx-auto px-6 py-3 flex justify-between items-center">
            <a href="#" class="text-xl font-bold text-gray-500 hover:text-gray-400">Proyecto:
                {{ config('app.name') }}</a>
            <p class="py-2 text-gray-500 sm:py-0">Ingenieria de sistemas</p>
        </div>
    </footer>
